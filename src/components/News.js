...
export class News extends Component {
    ...
    //       },
    //       "author": "Carla Mozée",
    //       "title": "US stocks mixed as traders mull impact of First Republic failure and brace for big Fed meeting",
    //       "description": "Trading in the month of May kicked off with the second largest US bank failure on record as traders prepped for a crucial Fed decision on Wednesday.",
    //       "url": "https://markets.businessinsider.com/news/stocks/stock-market-news-dow-first-republic-bank-failure-seizure-fed-2023-5",
    //       "urlToImage": "https://i.insider.com/641311ec5f4f54001919ddad?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-01T13:41:40Z",
    //       "content": "Traders on the floor of the New York Stock Exchange (NYSE)Spencer Platt/Getty Images\r\n<ul>\n<li>US stocks were mixed Monday following the failure and regulatory seizure of First Republic Bank. </li>\n<… [+3279 chars]"
    //     },
    //     {
    //       "source": {
    //         "id": "business-insider",
    ...
    //       "title": "Jack Dorsey encouraged the student who tracks Elon Musk's jet to keep posting on Bluesky after his Twitter ban",
    //       "description": "Jack Sweeney joined Jack Dorsey's latest social media venture Bluesky in April and set up his tracking account @ElonJet.",
    //       "url": "https://www.businessinsider.com/jack-dorsey-encourages-the-student-who-tracks-elon-musk-jet-2023-5",
    //       "urlToImage": "https://i.insider.com/645765a16a3ee80019092586?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-07T09:55:34Z",
    //       "content": "Jack Dorsey encouraged the college student who tracks Elon Musk's private jet to keep on posting.Jack Sweneey, Joe Raedle, Clive Mason/Getty Images\r\n<ul>\n<li>Jack Dorsey encouraged the college studen… [+3531 chars]"
    //     },
    //     {
    //       "source": {
    //         "id": "business-insider",
    ...
    //       },
    //       "author": "Carla Mozée",
    //       "title": "US stocks close lower after First Republic falls and ahead of the Fed's 2-day policy meeting",
    //       "description": "JPMorgan shares stood out as a gainer in the Dow on a losing day for US stocks after First Republic Bank collapsed.",
    //       "url": "https://markets.businessinsider.com/news/stocks/stock-market-news-dow-first-republic-bank-failure-nasdaq-jpmorgan-2023-5",
    //       "urlToImage": "https://i.insider.com/64500c5574e9330018efc500?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-01T20:08:02Z",
    //       "content": "Traders work on the floor at the New York Stock Exchange (NYSE) in New YorkReuters\r\n<ul>\n<li>US stocks fell on Monday after First Republic Bank collapsed on the first trading day of May. </li>\n<li>JP… [+3459 chars]"
    //     },
    //     {
    //       "source": {
    //         "id": "business-insider",
    ...
    //       },
    //       "author": "Carla Mozée",
    //       "title": "US stocks slide as Washington lacks movement on reaching a debt-ceiling agreement",
    //       "description": "Investors were anxious Tuesday with no word on a debt-ceiling deal. \"It's a slow walk,\" Rep. Patrick McHenry said, according to Roll Call.",
    //       "url": "https://markets.businessinsider.com/news/stocks/stock-market-news-today-nasdaq-dow-debt-ceiling-talks-sp500-2023-5",
    //       "urlToImage": "https://i.insider.com/6113ca37ad63f30019501f8b?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-23T20:06:56Z",
    //       "content": "Brendan McDermid/Reuters\r\n<ul>\n<li>US stocks fell Tuesday as debt-ceiling talks appeared to stall. </li>\n<li>\"It's a slow walk,\" Rep. Patrick McHenry said, according to Roll Call. </li>\n<li>The Treas… [+2790 chars]"
    //     },
    //     {
    //       "source": {
    //         "id": "business-insider",
    ...
    //       },
    //       "author": "Carla Mozée",
    //       "title": "US stocks edge higher as investors await updates on debt ceiling negotiations",
    //       "description": "The S&P 500 finished higher after two sessions in the red and after weekly back-to-back losses. Traders were waiting for debt ceiling talks to resume.",
    //       "url": "https://markets.businessinsider.com/news/stocks/stock-market-news-dow-nasdaq-debt-ceiling-talks-banks-sp500-2023-5",
    //       "urlToImage": "https://i.insider.com/5e8b238892e8ba33b0350f73?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-15T20:08:50Z",
    //       "content": "Lucas Jackson/Reuters\r\n<ul>\n<li>US stocks ended higher Monday, retracing early losses to end in the green. </li>\n<li>The S&P 500 rose with help from the financial sector as regional banks gained. </l… [+3568 chars]"
    //     },
    //     {
    //       "source": {
    //         "id": "business-insider",
    ...
    //       },
    //       "author": "Morgan Chittum",
    //       "title": "US stocks jump as Nvidia leads tech rally and investors wait on debt ceiling progress",
    //       "description": "Nvidia's huge quarterly earnings report led the Nasdaq higher, as investors pile into one of the clear leaders in the early days of the AI gold rush.",
    //       "url": "https://markets.businessinsider.com/news/stocks/stock-market-news-nasdaq-composite-nvidia-price-tech-sector-rally-2023-5",
    //       "urlToImage": "https://i.insider.com/63ab3e2147bbe40019837632?width=1200&format=jpeg",
    //       "publishedAt": "2023-05-25T13:43:59Z",
    //       "content": "Traders work on the floor of the New York Stock Exchange (NYSE) on October 27, 2022 in New York City.Spencer Platt/Getty Images\r\n<ul>\n<li>US stocks were mostly higher Thursday as Nvidia led a strong … [+3271 chars]"
    //     }
    //   ]
    constructor(){
        super();
     ...
     async componentDidMount(){
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=a97388b9f72f444fa2a0ef154cc9f813&page=1&pageSize=${this.props.pageSize}`
    ...
    handleNextClick = async() => {
        if(this.state.page + 1 > Math.ceil(this.state.totalResults/this.props.pageSize)){
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=a97388b9f72f444fa2a0ef154cc9f813&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`
            let data= await fetch(url);
            let parseData =await data.json();
            console.log(parseData);
